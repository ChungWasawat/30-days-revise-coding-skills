Get this set up from this github [local spark setup](https://github.com/athanan/spark-local-dev/tree/main)


<details>
    <summary><b>Instruction to start spark from the repository</b></summary>
